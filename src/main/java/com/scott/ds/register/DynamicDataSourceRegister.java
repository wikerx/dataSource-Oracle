package com.scott.ds.register;

import com.scott.ds.config.DynamicDataSourceContextHolder;
import com.scott.ds.config.DynamicRoutingDataSource;
import com.scott.ds.utils.AESUtil;
import com.scott.ds.utils.AppException;
...
//            logger.info("获取配置信息url：{}",defauleDataSourceProperties.get("url"));
                ...
                logger.error("master数据源url解密错误",e);
            }
            try {
...
//            logger.info("获取配置信息username：{}",defauleDataSourceProperties.get("username"));
                ...
                logger.error("master数据源username解密错误", e);
            }
            try {
...
//            logger.info("获取配置信息password：{}",defauleDataSourceProperties.get("password"));
                ...
                logger.error("master数据源password解密错误", e);
            }
    ...
    //            logger.info("获取配置信息url：{}",defauleDataSourceProperties.get("url"));
                        ...
                        logger.error(key + "数据源url解密错误", e);
                    }
                    try {
                        defauleDataSourceProperties.put("username", AESUtil.decrypt(defauleDataSourceProperties.get("username").toString()));
    //            logger.info("获取配置信息username：{}",defauleDataSourceProperties.get("username"));
                    } catch (Exception e) {
                        logger.error(key + "数据源username解密错误", e);
                    }
                    try {
                        defauleDataSourceProperties.put("password", AESUtil.decrypt(defauleDataSourceProperties.get("password").toString()));
    //            logger.info("获取配置信息password：{}",defauleDataSourceProperties.get("password"));
                    } catch (Exception e) {
                        logger.error(key + "数据源password解密错误", e);
                    }
                    // 绑定参数
